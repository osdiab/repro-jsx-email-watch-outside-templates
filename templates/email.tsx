...
import { someNumber } from '../other-code';
...
export const templateName = 'repro-jsx-email-watch-outside-templates';
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          <Text style={paragraph}>This is a number: {someNumber}</Text>
          <Button
            align={'center'}
            backgroundColor={'#777'}
            borderRadius={5}
